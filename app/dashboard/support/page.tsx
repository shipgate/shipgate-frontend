...
import { useSupportTicketMutation } from "@/store/slice/apiSlice";

export default function DashboardSupportPage() {
  const [supportTicketMutate, { data, isLoading: supportTicketIsLoading }] =
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-foreground/70 mb-3">
                    Instant messaging support available 24/7
                  </p>
                  <a
        ...
        <Card>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button
                disabled={supportTicketIsLoading}
                type="submit"
                className="bg-primary hover:bg-primary/90 text-white w-full h-12 font-semibold"
              >
                <Send className="w-4 h-4 mr-2" />
                {supportTicketIsLoading ? "Sending..." : "Send Ticket"}
              </Button>
            </form>
          </CardContent>
        </Card>
