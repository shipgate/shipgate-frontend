...
const initialArticles: BlogArticle[] = [
  {
    ...
    date: "2025-11-07",
    excerpt:
      "Learn the best practices for packaging your items to prevent damage during transit.",
    published: true,
  },
  {
    id: 2,
    ...
    date: "2025-11-05",
    excerpt:
      "Compare air and sea shipping options to make the best choice for your business needs.",
    published: true,
  },
  {
    id: 3,
    ...
    date: "2025-11-03",
    excerpt:
      "Everything you need to know about customs forms, HS codes, and required documentation.",
    published: true,
  },
];
...
function BlogAdminContent() {
  ...
  const filteredArticles = blogPosts?.data?.filter((article: any) => {
    const matchesSearch =
                  ...
                  >
                    ...
                    <td className="py-4 px-4">
                      ...
                      <button
                        ...
                        className={`px-3 py-1 rounded-full text-xs font-medium cursor-pointer transition-colors bg-green-100 text-green-700 hover:bg-green-200
